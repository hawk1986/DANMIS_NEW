...
{
    public interface ICandidateManager : IManager
    {
        /// <summary>
        /// 建立 Candidate
        /// </summary>
        ...
        /// <returns></returns>
        void Create(CandidateViewModel entity);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        CandidateViewModel GetByID(Guid id);
        ...
        /// <returns></returns>
        Paging<CandidateListResult> Paging(CandidateSearchModel searchModel);
