...
namespace DANMIS_NEW.Manager
{
    public class UserManager : IUserManager
    {
        ...
        public Paging<UserListResult> Paging(UserSearchModel searchModel)
        {
            ...
            var tempResult = from x in temp
                             select new UserListResult
                             {
                                 ...
                                 DeptCode = x.DeptCode,
                                 EmpNo = x.EmpNo,
                                 EmpEngOfficialName = x.EmpEngOfficialName,
                                 EmpLocName = x.EmpLocName,
                                 EmpGender = x.EmpGender,
                                 JobTitleCode = x.JobTitleCode,
                                 EmpStartDate = x.EmpStartDate.Value,
                                 EmpQuitDate = x.EmpQuitDate.Value,
                                 EmpStatusCode = x.EmpStatusCode,
                                 JobStatusCode = x.JobStatusCode,
                                 EmpCompEmail = x.EmpCompEmail,
                                 EmpADLoginID = x.EmpADLoginID,
                                 EmpComputerID = x.EmpComputerID,
                                 EmpPrivateEMail = x.EmpPrivateEMail,
                                 EmpHomePhone = x.EmpHomePhone,
                                 EmpMobilePhone = x.EmpMobilePhone,
                                 BossEmpUniqNo = x.BossEmpUniqNo.Value,
                                 EmpAcctStatus = x.EmpAcctStatus,
                                 WritingLanguage = x.WritingLanguage,
                                 SysLanguage = x.SysLanguage,
                                 EmpBankAccount = x.EmpBankAccount,
                                 EmpPhoto = x.EmpPhoto,
                                 CheckAttendance = x.CheckAttendance,
                                 ExtDisplayFlag = x.ExtDisplayFlag,
                                 SpcInTime = x.SpcInTime,
                                 SpcOutTime = x.SpcOutTime,
                                 InputBy = x.InputBy.Value,
                                 InputDate = x.InputDate.Value,
                                 ChangeBe = x.ChangeBe.Value,
                                 ChangeDate = x.ChangeDate.Value,
                                 Random = x.Random,
                                 NextBossEmpUniqNo = x.NextBossEmpUniqNo.Value,
                                 Do_PDP = x.Do_PDP,
                                 EmpExtNo = x.EmpExtNo,
                                 WDID = x.WDID,
                                 TaxiAccount = x.TaxiAccount,
                                 BrandCode = x.BrandCode,
                                 EmpType = x.EmpType,
                                 CostCenter = x.CostCenter,
                                 ProfitCenter = x.ProfitCenter,
                                 LastWorkDate = x.LastWorkDate.Value,
                                 CardNo = x.CardNo,
                                 FloorNo = x.FloorNo,
                                 SeatNo = x.SeatNo,
                                 MotoNo = x.MotoNo,
                                 MotocycleID = x.MotocycleID,
                                 ETag = x.ETag,
                                 MotoStartDate = x.MotoStartDate.Value,
                                 FaxNo = x.FaxNo,
                                 LeaseLine = x.LeaseLine,
                                 AssestNo = x.AssestNo,
                                 ThirdCode = x.ThirdCode,
                             };
        ...
        {
            var user = _userRepository.FirstOrDefault(x =>
                x.Email.ToLower() == viewModel.Account.ToLower() &&
                x.IsEnable);
