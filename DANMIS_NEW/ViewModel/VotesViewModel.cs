...
{
    public class VotesBaseModel
    {
        public VotesBaseModel()
        {
        }
        ...
        [Required(ErrorMessageResourceName = "RequiredError", ErrorMessageResourceType = typeof(Resource))]
        [StringLength(50, ErrorMessageResourceName = "StringLengthError", ErrorMessageResourceType = typeof(Resource))]
        [Display(Name = "VoteTo", ResourceType = typeof(Resource))]
        ...
        /// </summary>
        [Required(ErrorMessageResourceName = "RequiredError", ErrorMessageResourceType = typeof(Resource))]
        [Display(Name = "VoteDate", ResourceType = typeof(Resource))]
    ...
    public class VotesViewModel : VotesBaseModel
    {
        #region == View Fields ==
