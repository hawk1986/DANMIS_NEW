...
{
    public class WorkfrontReportBaseModel : PostedFileBaseModel
    {
        public WorkfrontReportBaseModel()
        {
        }
    ...
    public class WorkfrontReportViewModel : WorkfrontReportBaseModel
    {
        #region == View Fields ==
