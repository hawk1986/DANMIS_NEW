...
//     Generated at 03/11/2021 11:08:26
...
{
    public partial class BadProjectData
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static BadProjectData Convert(BadProjectDataViewModel source)
        {
            return source == null ? null : new BadProjectData
            {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static BadProjectDataViewModel Convert(BadProjectData source)
        {
            return source == null ? null : new BadProjectDataViewModel
            {
                SequenceNo = source.SequenceNo,
                ID = source.ID,
                WORK_CARD_NO = source.WORK_CARD_NO ?? string.Empty,
                ...
                CompareEngName = source.CompareEngName ?? string.Empty,
                ImportType = source.ImportType,
                CUST_ABBR = source.ProjectName.Split('-')[0] ?? string.Empty,
                PROD_NAME = source.ProjectName.Split('-')[1] ?? string.Empty,
                MEDIA_KIND_NAME = source.ProjectName.Split('-')[2] ?? string.Empty,
            };
        }
        ...
        /// </summary>
        /// <param name="source"></param>
        public static explicit operator BadProjectData(BadProjectDataViewModel source)
        {
        ...
        /// </summary>
        /// <param name="source"></param>
        public static explicit operator BadProjectDataViewModel(BadProjectData source)
        {
            return Convert(source);
        }
    }
