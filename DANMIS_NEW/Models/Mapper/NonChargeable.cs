...
//     Generated at 03/15/2021 18:34:12
...
namespace DANMIS_NEW.Models
{
    public partial class NonChargeable
    {
        ...
        /// <returns></returns>
        public static NonChargeable Convert(NonChargeableViewModel source)
        {
            return source == null ? null : new NonChargeable
            {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static NonChargeableViewModel Convert(NonChargeable source)
        {
            return source == null ? null : new NonChargeableViewModel
            {
                SequenceNo = source.SequenceNo,
                ID = source.ID,
                WORK_CARD_NO = source.WORK_CARD_NO ?? string.Empty,
        ...
        /// </summary>
        /// <param name="source"></param>
        public static explicit operator NonChargeable(NonChargeableViewModel source)
        {
        ...
        /// </summary>
        /// <param name="source"></param>
        public static explicit operator NonChargeableViewModel(NonChargeable source)
        {
            return Convert(source);
        }
    }
