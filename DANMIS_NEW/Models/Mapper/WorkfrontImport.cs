...
namespace DANMIS_NEW.Models
{
    public partial class WorkfrontImport
    {
        ...
        /// <returns></returns>
        public static WorkfrontImport Convert(WorkfrontImportViewModel source)
        {
            return source == null ? null : new WorkfrontImport
            {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static WorkfrontImportViewModel Convert(WorkfrontImport source)
        {
            return source == null ? null : new WorkfrontImportViewModel
            {
                SequenceNo = source.SequenceNo,
                ID = source.ID,
                Name = source.Name ?? string.Empty,
        ...
        /// </summary>
        /// <param name="source"></param>
        public static explicit operator WorkfrontImport(WorkfrontImportViewModel source)
        {
        ...
        /// </summary>
        /// <param name="source"></param>
        public static explicit operator WorkfrontImportViewModel(WorkfrontImport source)
        {
            return Convert(source);
        }
    }
